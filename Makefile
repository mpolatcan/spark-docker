...
publish-spark:
	...
	sudo docker push mpolatcan/spark:ubuntu-2.3.0-hadoop-2.7
	sudo docker rmi mpolatcan/spark:ubuntu-2.3.0-hadoop-2.7
	...
	sudo docker push mpolatcan/spark:alpine-2.3.0-hadoop-2.7
	sudo docker rmi mpolatcan/spark:alpine-2.3.0-hadoop-2.7
	...
	sudo docker push mpolatcan/spark:ubuntu-2.3.0-hadoop-2.6
	sudo docker rmi mpolatcan/spark:ubuntu-2.3.0-hadoop-2.6
	...
	sudo docker push mpolatcan/spark:alpine-2.3.0-hadoop-2.6
	sudo docker rmi mpolatcan/spark:alpine-2.3.0-hadoop-2.6
	...
	sudo docker push mpolatcan/spark:ubuntu-2.2.1-hadoop-2.7
	sudo docker rmi mpolatcan/spark:ubuntu-2.2.1-hadoop-2.7
	...
	sudo docker push mpolatcan/spark:alpine-2.2.1-hadoop-2.7
	sudo docker rmi mpolatcan/spark:alpine-2.2.1-hadoop-2.7
	...
	sudo docker push mpolatcan/spark:ubuntu-2.2.1-hadoop-2.6
	sudo docker rmi mpolatcan/spark:ubuntu-2.2.1-hadoop-2.6
	...
	sudo docker push mpolatcan/spark:alpine-2.2.1-hadoop-2.6
	sudo docker rmi mpolatcan/spark:alpine-2.2.1-hadoop-2.6
	...
	sudo docker push mpolatcan/spark:ubuntu-2.1.2-hadoop-2.7
	sudo docker rmi mpolatcan/spark:ubuntu-2.1.2-hadoop-2.7
	...
	sudo docker push mpolatcan/spark:alpine-2.1.2-hadoop-2.7
	sudo docker rmi mpolatcan/spark:alpine-2.1.2-hadoop-2.7
	...
	sudo docker push mpolatcan/spark:ubuntu-2.1.2-hadoop-2.6
	sudo docker rmi mpolatcan/spark:ubuntu-2.1.2-hadoop-2.6
	...
	sudo docker push mpolatcan/spark:alpine-2.1.2-hadoop-2.6
	sudo docker rmi mpolatcan/spark:alpine-2.1.2-hadoop-2.6
	...
	sudo docker push mpolatcan/spark:ubuntu-2.1.2-hadoop-2.4
	sudo docker rmi mpolatcan/spark:ubuntu-2.1.2-hadoop-2.4
	...
	sudo docker push mpolatcan/spark:alpine-2.1.2-hadoop-2.4
	sudo docker rmi mpolatcan/spark:alpine-2.1.2-hadoop-2.4
	...
	sudo docker push mpolatcan/spark:ubuntu-2.1.2-hadoop-2.3
	sudo docker rmi mpolatcan/spark:ubuntu-2.1.2-hadoop-2.3
	...
	sudo docker push mpolatcan/spark:alpine-2.1.2-hadoop-2.3
	sudo docker rmi mpolatcan/spark:alpine-2.1.2-hadoop-2.3
...
publish-sparkr:
	...
	sudo docker push mpolatcan/sparkr:ubuntu-2.3.0-hadoop-2.7
	sudo docker rmi mpolatcan/sparkr:ubuntu-2.3.0-hadoop-2.7
	...
	sudo docker push mpolatcan/sparkr:alpine-2.3.0-hadoop-2.7
	sudo docker rmi mpolatcan/sparkr:alpine-2.3.0-hadoop-2.7
	...
	sudo docker push mpolatcan/sparkr:ubuntu-2.3.0-hadoop-2.6
	sudo docker rmi mpolatcan/sparkr:ubuntu-2.3.0-hadoop-2.6
	...
	sudo docker push mpolatcan/sparkr:alpine-2.3.0-hadoop-2.6
	sudo docker rmi mpolatcan/sparkr:alpine-2.3.0-hadoop-2.6
	...
	sudo docker push mpolatcan/sparkr:ubuntu-2.2.1-hadoop-2.7
	sudo docker rmi mpolatcan/sparkr:ubuntu-2.2.1-hadoop-2.7
	...
	sudo docker push mpolatcan/sparkr:alpine-2.2.1-hadoop-2.7
	sudo docker rmi mpolatcan/sparkr:alpine-2.2.1-hadoop-2.7
	...
	sudo docker push mpolatcan/sparkr:ubuntu-2.2.1-hadoop-2.6
	sudo docker rmi mpolatcan/sparkr:ubuntu-2.2.1-hadoop-2.6
	...
	sudo docker push mpolatcan/sparkr:alpine-2.2.1-hadoop-2.6
	sudo docker rmi mpolatcan/sparkr:alpine-2.2.1-hadoop-2.6
	...
	sudo docker push mpolatcan/sparkr:ubuntu-2.1.2-hadoop-2.7
	sudo docker rmi mpolatcan/sparkr:ubuntu-2.1.2-hadoop-2.7
	...
	sudo docker push mpolatcan/sparkr:alpine-2.1.2-hadoop-2.7
	sudo docker rmi mpolatcan/sparkr:alpine-2.1.2-hadoop-2.7
	...
	sudo docker push mpolatcan/sparkr:ubuntu-2.1.2-hadoop-2.6
	sudo docker rmi mpolatcan/sparkr:ubuntu-2.1.2-hadoop-2.6
	...
	sudo docker push mpolatcan/sparkr:alpine-2.1.2-hadoop-2.6
	sudo docker rmi mpolatcan/sparkr:alpine-2.1.2-hadoop-2.6
	...
	sudo docker push mpolatcan/sparkr:ubuntu-2.1.2-hadoop-2.4
	sudo docker rmi mpolatcan/sparkr:ubuntu-2.1.2-hadoop-2.4
	...
	sudo docker push mpolatcan/sparkr:alpine-2.1.2-hadoop-2.4
	sudo docker rmi mpolatcan/sparkr:alpine-2.1.2-hadoop-2.4
	...
	sudo docker push mpolatcan/sparkr:ubuntu-2.1.2-hadoop-2.3
	sudo docker rmi mpolatcan/sparkr:ubuntu-2.1.2-hadoop-2.3
	...
	sudo docker push mpolatcan/sparkr:alpine-2.1.2-hadoop-2.3
	sudo docker rmi mpolatcan/sparkr:alpine-2.1.2-hadoop-2.3
...
publish-pyspark:
	...
	sudo docker push mpolatcan/pyspark:ubuntu-2.3.0-hadoop-2.7
	sudo docker rmi mpolatcan/pyspark:ubuntu-2.3.0-hadoop-2.7
	...
	sudo docker push mpolatcan/pyspark:alpine-2.3.0-hadoop-2.7
	sudo docker rmi mpolatcan/pyspark:alpine-2.3.0-hadoop-2.7
	...
	sudo docker push mpolatcan/pyspark:ubuntu-2.3.0-hadoop-2.6
	sudo docker rmi mpolatcan/pyspark:ubuntu-2.3.0-hadoop-2.6
	...
	sudo docker push mpolatcan/pyspark:alpine-2.3.0-hadoop-2.6
	sudo docker rmi mpolatcan/pyspark:alpine-2.3.0-hadoop-2.6
	...
	sudo docker push mpolatcan/pyspark:ubuntu-2.2.1-hadoop-2.7
	sudo docker rmi mpolatcan/pyspark:ubuntu-2.2.1-hadoop-2.7
	...
	sudo docker push mpolatcan/pyspark:alpine-2.2.1-hadoop-2.7
	sudo docker rmi mpolatcan/pyspark:alpine-2.2.1-hadoop-2.7
	...
	sudo docker push mpolatcan/pyspark:ubuntu-2.2.1-hadoop-2.6
	sudo docker rmi mpolatcan/pyspark:ubuntu-2.2.1-hadoop-2.6
	...
	sudo docker push mpolatcan/pyspark:alpine-2.2.1-hadoop-2.6
	sudo docker rmi mpolatcan/pyspark:alpine-2.2.1-hadoop-2.6
	...
	sudo docker push mpolatcan/pyspark:ubuntu-2.1.2-hadoop-2.7
	sudo docker rmi mpolatcan/pyspark:ubuntu-2.1.2-hadoop-2.7
	...
	sudo docker push mpolatcan/pyspark:alpine-2.1.2-hadoop-2.7
	sudo docker rmi mpolatcan/pyspark:alpine-2.1.2-hadoop-2.7
	...
	sudo docker push mpolatcan/pyspark:ubuntu-2.1.2-hadoop-2.6
	sudo docker rmi mpolatcan/pyspark:ubuntu-2.1.2-hadoop-2.6
	...
	sudo docker push mpolatcan/pyspark:alpine-2.1.2-hadoop-2.6
	sudo docker rmi mpolatcan/pyspark:alpine-2.1.2-hadoop-2.6
	...
	sudo docker push mpolatcan/pyspark:ubuntu-2.1.2-hadoop-2.4
	sudo docker rmi mpolatcan/pyspark:ubuntu-2.1.2-hadoop-2.4
	...
	sudo docker push mpolatcan/pyspark:alpine-2.1.2-hadoop-2.4
	sudo docker rmi mpolatcan/pyspark:alpine-2.1.2-hadoop-2.4
	...
	sudo docker push mpolatcan/pyspark:ubuntu-2.1.2-hadoop-2.3
	sudo docker rmi mpolatcan/pyspark:ubuntu-2.1.2-hadoop-2.3
	...
	sudo docker push mpolatcan/pyspark:alpine-2.1.2-hadoop-2.3
	sudo docker rmi mpolatcan/pyspark:alpine-2.1.2-hadoop-2.3
